...
cmake .. -DCMAKE_INSTALL_PREFIX=~/.local/kokkos -DBUILD_SHARED_LIBS=yes -DKokkos_ENABLE_CUDA=yes -DKokkos_ENABLE_OPENMP=yes -DKokkos_ARCH_AMPERE80=yes -DKokkos_ENABLE_CUDA_LAMBDA=yes # -DKokkos_ENABLE_SERIAL=yes -DKokkos_ARCH_TURING75=yes
make -j
make install
cd ../../../../../
...
-DPKG_PLUGIN=yes -DCMAKE_INSTALL_PREFIX=${HOME}/.local/lammps -DBUILD_MPI=yes -DBUILD_SHARED_LIBS=yes -DLAMMPS_MACHINE=mpi \
